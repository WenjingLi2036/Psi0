...
# TASK="When the fake face comes in, pick up the spoon on top of the tape and feed the fake mouth. After biting, retrieve the spoon gently and place the spoon back on the tape."
